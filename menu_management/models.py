...
class Cautions(models.Model):
    ...
    created_by = models.ForeignKey(CustomUser, verbose_name='作成者', null=True, blank=True, on_delete=models.SET_NULL, related_name='cautions_created_by')
    updated_by = models.ForeignKey(CustomUser, verbose_name='更新者', null=True, blank=True, on_delete=models.SET_NULL, related_name='cautions_updated_by')
...
class Menus(models.Model):
    ...
    created_by = models.ForeignKey(CustomUser, verbose_name='作成者', null=True, blank=True, on_delete=models.SET_NULL, related_name='menus_created_by')
    updated_by = models.ForeignKey(CustomUser, verbose_name='更新者', null=True, blank=True, on_delete=models.SET_NULL, related_name='menus_updated_by')
    created_at = models.DateTimeField(verbose_name='作成日時', auto_now_add=True)
    updated_at = models.DateTimeField(verbose_name='更新日時', auto_now=True)
